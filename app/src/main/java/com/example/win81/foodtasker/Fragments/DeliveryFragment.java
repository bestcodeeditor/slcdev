package com.example.win81.foodtasker.Fragments;
    ...
    private void drawRouteOnMap(JSONObject response){
        ...
        try{
            ...
            if (!resAddresses.isEmpty() && !ordAddresses.isEmpty()){
                ...
                DrawRouteMaps.getInstance(getActivity(),"AIzaSyDxuTVLlWioHPkIuZnObwxZkKGgZboF5gc").draw(restaurantPos, orderPos, mMap);
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (mLastKnownLocation != null){
                                ...
                                Log.d("'NEW LOCATION:",Double.toString(pos.latitude) + "," + Double.toString(pos.longitude));
